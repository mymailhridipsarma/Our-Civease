...
export default function CitizenDashboardPage() {
  ...
  // After user is known, fetch their issues using citizenId=<user.id>
  useEffect(() => {
    if (!user?.id) return
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8">
        ...
        {/* Key Metrics – responsive like authority */}
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <Card className="min-w-0">
            ...
            <CardContent>
              ...
              <p className="text-[11px] sm:text-xs text-muted-foreground mt-1">
                Being worked on by authorities
              </p>
            </CardContent>
          </Card>
